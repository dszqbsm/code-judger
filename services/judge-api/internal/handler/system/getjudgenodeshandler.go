...
func GetJudgeNodesHandler(svcCtx *svc.ServiceContext) http.HandlerFunc {
	return func(w http.ResponseWriter, r *http.Request) {
		var req types.GetJudgeNodesReq
		if err := httpx.Parse(r, &req); err != nil {
			httpx.ErrorCtx(r.Context(), w, err)
			return
		}

		l := system.NewGetJudgeNodesLogic(r.Context(), svcCtx)
		resp, err := l.GetJudgeNodes(&req)
		if err != nil {
			httpx.ErrorCtx(r.Context(), w, err)
		} else {
